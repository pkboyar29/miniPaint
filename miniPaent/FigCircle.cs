...
namespace miniPaent
{
    internal class FigCircle : Figura
    {
        /// <summary>
        ...
        public FigCircle(float width, Color color, Point startPoint, Point endPoint) : base(width, color)
        {
        ...
        public override void Draw(Graphics gr)
        {
            ...
            gr.DrawEllipse(new Pen(Color, Width), rect);
        }
